  ...
  try {
    ...
    const response = await fetch('https://api.groq.com/openai/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        max_tokens: 1000,
        messages: [
          { role: 'system', content: system || 'You are a helpful crop disease detection assistant. Help farmers identify and treat crop diseases.' },
          ...messages
        ],
        temperature: 0.7,
      }),
    ...
    // Return in Anthropic-compatible format so chatbot.js works without changes
